...
dropped_collumns = [
    ...
    'client_age_sq',
    'Length',
    'Max_products',      # 0.04 - skoro nula
    'Type_fuel',         # 0.09 - zanemarljivo
    'driving_exp_sqrt',  # duplikat driving_exp_years
    'driving_exp_sq',    # duplikat driving_exp_years
    'contract_age_sqrt', # duplikat contract_age_months
    'contract_age_sq',   # duplikat contract_age_months
    'client_age_sqrt',   # duplikat client_age
]
